  ...
  return (
    <Frame>
      ...
      >
        ...
        >
          <Sparkles className="w-4 h-4" /> Order similar
        </button>
      </div>
          ...
          <aside className="lg:sticky lg:top-24 self-start space-y-4">
            ...
            >
              ...
              <p className="text-sm font-semibold text-foreground mb-1">
                We can build you something similar.
              </p>
              ...
              <div className="space-y-2 mt-3">
                ...
                >
                  Use the AI estimator <ArrowRight className="w-3.5 h-3.5" />
                </button>
              </div>
            </div>
          </aside>
        ...
        <section className="mt-20 py-16 border-t border-border" style={{ background: 'var(--token-surface)' }}>
          <div className="max-w-4xl mx-auto px-6 sm:px-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              >
                <Sparkles className="w-4 h-4" /> Get my estimate
              </button>
              <button
                onClick={() => setModal({ intent: 'consultation' })}
